...
class Command(BaseCommand):
    ...
    def _create_users(self):
        admin = User.objects.create_user(username='admin', password=env('ADMIN_USER_PASS'), first_name='Kelly', last_name='Hughes', email='flpadmin@gmail.com')
        admin.is_staff = True 
        ...
        sow = User.objects.create_user(username='staff', password=env('STAFF_USER_PASS'), first_name='Max', last_name='K', email='mk@gmail.com')
        sow.is_staff = True 
